...
This issue happens with installing Chaos Mesh on Kubernetes which lower than 1.16. We use `apiextensions.k8s.io/v1` as the default, but it was introduced in Kubernetes 1.16 at 2019-09-19.
